        ...
        placeOrderButton.addActionListener(new ActionListener() {
            ...
            private void generarFacturaPDF() {
                try {
                    ...
                    document.add(new Paragraph("Factura de Venta", new Font(Font.FontFamily.HELVETICA, 18, Font.BOLD)));
                    document.add(new Paragraph("Numero de orden: " + textField1.getText()));
                    document.add(new Paragraph("Fecha: " + textField2.getText()));
                    document.add(new Paragraph("Cliente: " + comboBox2.getSelectedItem().toString()));
                    document.add(new Paragraph("Categoría: " + textField3.getText()));
                    ...
                    JOptionPane.showMessageDialog(null, "Factura generada y guardada correctamente en descargas: " + filePath);
